...
from database import (
    get_book_by_id, get_book_by_isbn, get_patron_borrow_count, get_patron_borrow_history,
...
def borrow_book_by_patron(patron_id: str, book_id: int) -> Tuple[bool, str]:
    ...
    for borrowed_book in borrowed_books:
        if book['id'] == borrowed_book['book_id']:
            return False, "Cannot borrow a book that you already borrowed."
...
def return_book_by_patron(patron_id: str, book_id: int) -> Tuple[bool, str]:
    ...
    fee = late_fee_data.get("fee_amount")
...
def get_patron_status_report(patron_id: str) -> Dict:
    ...
    """
    borrowed_books = get_patron_borrowed_books(patron_id)
    history = get_patron_borrow_history(patron_id)
